...
class FinancialTimeFrameAlignerTest {
    ...
    @BeforeEach
    void setUp() {
        aligner = new FinancialTimeFrameAligner();
    }
    ...
    class IntradayTests {
        ...
        @Test
        @DisplayName("Intraday un Samedi -> Recule au Samedi 00:00 (Fin du Vendredi)")
        void testIntradayOnSaturday() {
            // Samedi 15 Juin 2024 à 14h25
            ZonedDateTime saturday = ZonedDateTime.of(2024, 6, 15, 14, 25, 0, 0, UTC);
            ZonedDateTime result = aligner.alignFloor(saturday, TimeFrame.MI5);

            assertEquals(2024, result.getYear());
            assertEquals(6, result.getMonthValue());
            assertEquals(15, result.getDayOfMonth()); // Samedi 15 à 00:00 = Fin du Vendredi 14
    ...
    class DailyTests {
        ...
        @Test
        @DisplayName("Samedi 14h00 -> Samedi 00:00 (Fin du Vendredi)")
        void testSaturday() {
        ...
        @Test
        @DisplayName("Dimanche 20h00 -> Samedi 00:00 (Fin du Vendredi)")
        void testSunday() {
        ...
        void testMayFirstHoliday() {
            ...
            // Le 1er mai étant férié, recule au minuit marquant la fin du Mardi 30 Avril -> 1er Mai 00:00:00
            assertEquals(5, result.getMonthValue());
            assertEquals(1, result.getDayOfMonth());
            assertEquals(0, result.getHour());

            ZonedDateTime maySecond = ZonedDateTime.of(2024, 5, 1, 14, 0, 0, 0, UTC);
        ...
        void testNewYearHolidayTransition() {
            ...
            // Dimanche 31 Déc et Lundi 1er Janv sont non-ouvrés -> Recule jusqu'au Samedi 30 Déc 00:00 (Fin du Vendredi 29 Déc)
    ...
    class WeeklyTests {
        ...
        @ValueSource(ints = {10, 11, 12, 13, 14}) // Lundi 10 au Vendredi 14 Juin 2024
        void testUnclosedWeekDays(int dayOfMonth) {
            ...
            // Semaine non finie -> renvoie la clôture de la semaine précédente (Samedi 8 Juin 00:00)
            assertEquals(6, result.getMonthValue());
        ...
        @Test
        @DisplayName("Samedi (15 Juin) -> Semaine clôturée -> Renvoie Samedi 15 Juin 00:00")
        ...
        @Test
        @DisplayName("Dimanche (16 Juin) -> Semaine clôturée -> Renvoie Samedi 15 Juin 00:00")
        ...
        @Test
        @DisplayName("Semaine avec Noël (Mercredi 25 Décembre 2024) -> Semaine clôturée normalement le Samedi 28 Décembre")
        void testChristmasWeek() {
            // Samedi 28 Décembre 2024
            ZonedDateTime saturdayAfterChristmas = ZonedDateTime.of(2024, 12, 28, 11, 0, 0, 0, UTC);
        ...
        void testWeekEndingOnFridayHoliday() {
            ...
            // getEndOfLastBusinessDay(saturday) recule jusqu'au Vendredi 25 Décembre 00:00:00.
    ...
    class MonthlyTests {
        ...
        void testMidMonthToPreviousMonth() {
            ...
            // 31 Mai était Vendredi ouvré. Fin du mois de Mai = Samedi 1er Juin 00:00:00
            assertEquals(6, result.getMonthValue());
            assertEquals(1, result.getDayOfMonth());
            assertEquals(0, result.getHour());
        }
        ...
        @Test
        @DisplayName("Fin de mois tombant un Dimanche (30 Juin 2024) -> Mois clôturé le Samedi 29 Juin 00:00")
        void testMonthEndingOnWeekend() {
            ...
            assertEquals(6, result.getMonthValue());
            assertEquals(29, result.getDayOfMonth()); // Samedi 29 Juin 00:00:00
            assertEquals(0, result.getHour());
        }
        ...
        void testMonthEndingWithHoliday() {
            ...
            // Décembre n'est pas fini -> clôture de Novembre (Novembre finit le Samedi 30 Novembre)
            assertEquals(11, result.getMonthValue());
            assertEquals(30, result.getDayOfMonth());
        }

        @Test
        @DisplayName("Passage d'année (15 Janvier 2024) -> Clôture Décembre 2023 (Samedi 30 Décembre 00:00)")
        void testYearTransition() {
            ...
            // 29 Décembre 2023 était un Vendredi. Fin de Décembre = Samedi 30 Décembre 00:00:00
            assertEquals(2023, result.getYear());
            assertEquals(12, result.getMonthValue());
            assertEquals(30, result.getDayOfMonth());
            assertEquals(0, result.getHour());
        ...
        @Test
        @DisplayName("Février bissextile (29 Fév 2024 Jeudi) -> Interrogé le 1er Mars -> Vendredi 1er Mars 00:00")
        ...
        @Test
        @DisplayName("Février non bissextile (28 Fév 2023 Mardi) -> Interrogé le 1er Mars -> Mercredi 1er Mars 00:00")
